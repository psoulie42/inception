*This project has been created as part of the 42 curriculum by squement*
...
* `make fclean`: Performs a full cleanup, including the deletion of persistent data in `/home/squement/data`.
